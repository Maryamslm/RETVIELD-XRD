...
def plot_rietveld_publication(two_theta, observed, calculated, difference,
    ...
    phase_data: list of dicts with keys: 'name', 'positions', 'color', 'marker_shape', 'hkl' (optional)
    """
...
with tabs[6]:
    ...
    if "last_result" not in st.session_state:
        ...
        with col_e1:
            ...
            href = f'<a href="data:application/pdf;base64,{b64}" download="rietveld_publication.pdf" style="display:inline-block;padding:8px 16px;background:#1f77b4;color:white;border-radius:4px;text-decoration:none;font-weight:500">📄 Download PDF</a>'
        ...
        with col_e2:
            ...
            buf.seek(0)
            b64 = base64.b64encode(buf.read()).decode()
            href = f'<a href="data:image/png;base64,{b64}" download="rietveld_publication_300dpi.png" style="display:inline-block;padding:8px 16px;background:#2ca02c;color:white;border-radius:4px;text-decoration:none;font-weight:500">🖼️ Download PNG (300 DPI)</a>'
            st.markdown(href, unsafe_allow_html=True)
        ...
        with col_e3:
            ...
            buf.seek(0)
            b64 = base64.b64encode(buf.read()).decode()
            href = f'<a href="data:application/postscript;base64,{b64}" download="rietveld_publication.eps" style="display:inline-block;padding:8px 16px;background:#ff7f0e;color:white;border-radius:4px;text-decoration:none;font-weight:500">📐 Download EPS</a>'
            st.markdown(href, unsafe_allow_html=True)
